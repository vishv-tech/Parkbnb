...
export default function TermsPage() {
  return (
    <PublicPageShell
      eyebrow="Legal"
      title="Terms & Conditions"
      intro="These Terms & Conditions describe basic responsibilities for using the Park2bnb MVP as a parking owner, parking seeker, or platform admin user."
    >
      <InfoCard title="Platform terms">
        <BulletList
          items={[
            "Park2bnb is a parking marketplace connecting parking owners and parking seekers.",
            ...
            "Park2bnb may block users for misuse.",
            "Park2bnb is not responsible for false information submitted by users.",
