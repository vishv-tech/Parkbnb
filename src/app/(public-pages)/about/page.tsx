...
export default function AboutPage() {
  return (
    <PublicPageShell
      eyebrow="About us"
      title="About Park2bnb"
      intro="Park2bnb is an Airbnb-style parking marketplace where parking owners can list unused parking spaces and drivers can find and book nearby parking."
    >
      <InfoCard title="A simpler parking marketplace">
        <p>
          Park2bnb connects people who have available parking space with drivers who need safe,
      ...
      <InfoCard title="What Park2bnb helps with">
        <BulletList
          items={[
